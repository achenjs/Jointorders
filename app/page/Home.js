...
export default class Home extends Component {
    ...
    pickBtnClick () {
    	let params = this.props.params
			let arr = ["#confirmOrder"]
			params.tableNum = params.tableNum ? params.tableNum : $.cookie('tableNum')
			arr.push(params.tableNum)
			params.orderNum ? arr.push(params.orderNum) : arr
