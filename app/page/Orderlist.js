...
export default class Orderlist extends Component {
    ...
    handleJump (orderNum, tableNum) {
        location.href = ["#orderform", orderNum, tableNum].join("/");
    }
    ...
    render() {
        ...
        var orderListStr = list.reverse().map((item,i) => {
            return (
                <div className="orderstatus-detail" onClick={this.handleJump.bind(this, item.orderNum, item.tableNum)} key={i}>
                    <div>
