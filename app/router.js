...
window.statusCode = {
	...
	// $.cookie("storeCode", "1401259342578")
	// $.cookie("loginName", "achen")
	// $.cookie("tableNum", "0030")
	...
	function onLeave(from) {
		fromName = from.location.pathname.split("/")[1]
		// var to = location.hash.split("/")[1]
		// if (fromName == 'orderform' && to == 'confirmOrder') {
		// 	location.href = ["#home", from.params.orderNum || ''].join("/")
		// }
	}
	function onEnter(from){
		...
		if (fromName == 'orderform' && route == 'confirmOrder') {
			location.href = ["#home", from.params.orderNum || ''].join("/")
		}
	...
	ReactDOM.render((
		<Router history={hashHistory}>
			<Route path="/number" component={Number} socket={socket} onLeave={onLeave.bind(this)} onEnter={onEnter.bind(this)}/>
			<Route path="/home(/:orderNum)(/:tableNum)" component={Home} socket={socket} onLeave={onLeave.bind(this)} onEnter={onEnter.bind(this)}/>
			<Route path="/confirmOrder(/:tableNum)(/:orderNum)" component={ConfirmOrder} socket={socket} onLeave={onLeave.bind(this)} onEnter={onEnter.bind(this)}/>
			<Route path="/orderform/:orderNum(/:tableNum)" component={Orderform} socket={socket} onLeave={onLeave.bind(this)}  onEnter={onEnter.bind(this)}/>
			<Route path="/pay/:orderNum" component={Pay} socket={socket} onLeave={onLeave.bind(this)} onEnter={onEnter.bind(this)} />
			<Route path="/orderlist" component={Orderlist} socket={socket} onLeave={onLeave.bind(this)} onEnter={onEnter.bind(this)}/>
